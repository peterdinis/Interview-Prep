            ...
            <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/50">
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                        Ready to Ace Your
                        <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"> Next Interview?</span>
                    </h2>
                    <p className="text-xl text-gray-600 mb-10 leading-relaxed">
                        Join over 50,000 developers who have successfully prepared with InterviewAce.
