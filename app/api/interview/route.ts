            ...
            'https://api.openai.com/v1/completions',
            {
                ...
                body: JSON.stringify({
                    prompt: showQuestions
                        ? `Create a mock interview for a ${jobPosition} with experience in ${jobDesc} and ${jobExperience} years of experience. Generate ${numQuestions} questions. Do not generare answers.`
